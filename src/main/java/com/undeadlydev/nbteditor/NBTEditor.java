package com.undeadlydev.nbteditor;
...
public final class NBTEditor {
    ...
    private static Object createItemStack( Object compound ) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, InstantiationException, NoSuchFieldException, SecurityException {
        if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_21_R6 ) ) {
            return ReflectionTarget.v1_21_R6.getItemFrom( registryAccess(), compound );
    ...
    private static Object getCompound( ItemStack item ) {
        ...
        try {
            ...
            if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_21_R6 ) ) {
                tag = ReflectionTarget.v1_21_R6.save( stack, registryAccess() );
            } else if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_20_R4 ) ) {
                Method saveOptional = getMethod( MethodId.saveOptional );
                if ( saveOptional != null ) {
                    tag = saveOptional.invoke( stack, registryAccess() );
                } else {
                    if ( (Boolean) getMethod( MethodId.itemHasTag ).invoke( stack ) ) {
            ...
            if (tag instanceof Optional) {
                Optional<?> optional = (Optional<?>) tag;
                tag = optional.isPresent() ? optional.get() : null;
            }
    ...
    private static ItemStack setItemTag( ItemStack item, Object value, Object... keys ) {
        ...
        try {
            ...
            if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_21_R6 ) ) {
                Object nmsItem = ReflectionTarget.v1_21_R6.getItemFrom( registryAccess(), tag );
                return (ItemStack) getMethod( MethodId.asBukkitCopy ).invoke( null, nmsItem );
            } else if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_20_R4 ) ) {
                Object nmsItem = createItemStack( tag );
                return (ItemStack) getMethod( MethodId.asBukkitCopy ).invoke( null, nmsItem );
            } else {
    ...
    private static Object getCompound( Entity entity ) {
        ...
        try {
            ...
            if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_21_R6 ) ) {
                final Object tagValueOutput = ReflectionTarget.v1_21_R6.newTagValueOutput( registryAccess() );
    ...
    private static void setEntityTag( Entity entity, Object value, Object... keys ) {
        ...
        try {
            ...
            if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_21_R6 ) ) {
                final Object valueInput = ReflectionTarget.v1_21_R6.getValueInputFromNbtTagCompound( registryAccess(), tag );
    ...
    private static void setBlockTag( Block block, Object value, Object... keys ) {
        try {
            ...
            if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_21_R6 ) ) {
                ...
                setTileTag.invoke( tileEntity, ReflectionTarget.v1_21_R6.getValueInputFromNbtTagCompound( registryAccess(), tag ) );
            } else if ( LOCAL_VERSION.greaterThanOrEqualTo( MinecraftVersion.v1_20_R4 ) ) {
                Method setTileTag = getMethod( MethodId.setTileTag );
    ...
    private static abstract class ReflectionTarget implements Comparable<ReflectionTarget> {
        ...
        private final Map<MethodId, ReflectionTarget.ConstructorTarget> methodTargets = new HashMap<MethodId, ReflectionTarget.ConstructorTarget>();
        private final Map<ClassId, ReflectionTarget.ConstructorTarget> constructorTargets = new HashMap<ClassId, ReflectionTarget.ConstructorTarget>();
        ...
        protected final ReflectionTarget.MethodTarget addMethod(MethodId name, ClassId clazz, String methodName, Object... params ) {
            ReflectionTarget.MethodTarget newTarget = new ReflectionTarget.MethodTarget( clazz, methodName, params );
            methodTargets.put( name, newTarget );
            return newTarget;
        }

        protected final ReflectionTarget.ReturnMethodTarget addMethod(MethodId name, ClassId clazz, ClassId returnType, Object... params ) {
            ReflectionTarget.ReturnMethodTarget newTarget = new ReflectionTarget.ReturnMethodTarget( clazz, returnType, params );
            methodTargets.put( name, newTarget );
            return newTarget;
        }

        protected final void addConstructor(ClassId clazz, Object... params ) {
            constructorTargets.put( clazz, new ReflectionTarget.ConstructorTarget( clazz, params ) );
        }
        ...
        protected final Method fetchMethod( MethodId name ) throws NoSuchMethodException, SecurityException, ClassNotFoundException {
            ReflectionTarget.ConstructorTarget constructorTarget = methodTargets.get( name );
            if ( constructorTarget instanceof ReflectionTarget.MethodTarget) {
                ReflectionTarget.MethodTarget target = (ReflectionTarget.MethodTarget) constructorTarget;
            ...
            } else if ( constructorTarget instanceof ReflectionTarget.ReturnMethodTarget) {
                ReflectionTarget.ReturnMethodTarget target = (ReflectionTarget.ReturnMethodTarget) constructorTarget;
                Class< ? > clazz = findClass( target.clazz );
        ...
        protected final Constructor< ? > fetchConstructor( ClassId name ) throws NoSuchMethodException, SecurityException, ClassNotFoundException {
            final ReflectionTarget.ConstructorTarget target = constructorTargets.get( name );
        ...
        private static class MethodTarget extends ReflectionTarget.ConstructorTarget {
            final String name;
            ...
            public ReflectionTarget.MethodTarget failSilently(boolean silent ) {
                this.silent = silent;
                return this;
            }
        }

        private static class ReturnMethodTarget extends ReflectionTarget.ConstructorTarget {
        ...
        private static class v1_21_R5 extends ReflectionTarget {
            ...
            private static Object getNbtOps() throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
                if ( NBT_OPS == null ) {
                    NBT_OPS = getNMSClass( ClassId.NbtOps ).getField("INSTANCE").get(null);
                }
                return NBT_OPS;
            }
        ...
        private static class v1_21_R6 extends ReflectionTarget {
            ...
            protected v1_21_R6() {
                ...
                addClass( ClassId.Codec, "com.mojang.serialization.Codec" );
                addClass( ClassId.DynamicOps, "com.mojang.serialization.DynamicOps" );
                addClass( ClassId.NbtOps, "net.minecraft.nbt.NbtOps" );
                addClass( ClassId.ValueInput, "net.minecraft.world.level.storage.ValueInput" );
                addClass( ClassId.TagValueInput, "net.minecraft.world.level.storage.TagValueInput" );
                addClass( ClassId.ValueOutput, "net.minecraft.world.level.storage.ValueOutput" );
                addClass( ClassId.TagValueOutput, "net.minecraft.world.level.storage.TagValueOutput" );
            ...
            protected static Object getItemFrom( final Object registryAccess, final Object compound ) throws IllegalAccessException, InvocationTargetException, IllegalArgumentException, NoSuchFieldException, SecurityException {
                Object result = getMethod( MethodId.decoderParse ).invoke( getItemStackCodec(), getMethod( MethodId.createSerializationContext ).invoke( registryAccess, getNbtOps() ), compound );
                return getMethod( MethodId.getOrThrow ).invoke( result );
            }

            protected static Object save( final Object item, final Object registryAccess ) throws IllegalAccessException, InvocationTargetException, IllegalArgumentException, NoSuchFieldException, SecurityException {
                Object result = getMethod( MethodId.encoderEncodeStart ).invoke( getItemStackCodec(), getMethod( MethodId.createSerializationContext ).invoke( registryAccess, getNbtOps() ), item );
                return getMethod( MethodId.getOrThrow ).invoke( result );
            }
        }
    }
